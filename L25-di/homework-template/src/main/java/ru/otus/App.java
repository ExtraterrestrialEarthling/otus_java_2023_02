...
import ru.otus.config.splitconfig.AppConfig1;
import ru.otus.config.splitconfig.AppConfig2;
...
public class App {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //AppComponentsContainer container = new AppComponentsContainerImpl("ru.otus.config.splitconfig");
